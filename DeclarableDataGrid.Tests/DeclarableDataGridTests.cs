...
namespace DeclarableDataGrid.Tests
{
    public class DeclarableDataGridTests
    {
        ...
        {
            // Arrange
            TestCollection.UseDynamicColumn("TestDynamicColumn", typeof(string), x => x.WithDisplayIndex(10).WithDisplayName("Test dynamic column"));
        ...
        public void DynamicColumnBuilder_ShouldValidateAddedType()
        {
            ...
            TestCollection.UseDynamicColumn("TestComplexProperty", typeof(TestBaseClass), x => x.WithDisplayIndex(1));
